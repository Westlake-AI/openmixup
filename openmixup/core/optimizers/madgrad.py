...
class MADGRAD(torch.optim.Optimizer):
    ...
    Implementation of `Adaptivity without Compromise: A Momentumized, Adaptive, Dual Averaged
    Gradient Method for Stochastic Optimization (arXiv'2021) <https://arxiv.org/abs/2101.11075>`_.

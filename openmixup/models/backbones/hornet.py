...
class GlobalLocalFilter(nn.Module):
    ...
    def forward(self, x):
        ...
        B, C, a, b = x2.shape
        x2 = fft.rfft2(x2, dim=(2, 3), norm='ortho')
        ...
        x2 = x2 * weight
        x2 = fft.irfft2(x2, s=(a, b), dim=(2, 3), norm='ortho')
...
class HorNetBlock(nn.Module):
    ...
    def __init__(self,
        ...
        if use_layer_scale:
            ...
            self.gamma2 = LayerScale(dim, data_format='channels_last')
        else:
...
class HorNet(BaseBackbone):
    ...
    A PyTorch implementation of : `HorNet: Efficient High-Order Spatial Interactions
    with Recursive Gated Convolutions <https://arxiv.org/abs/2207.14284>`_

    Modified from the `official repo
    <https://github.com/raoyongming/HorNet>`_
    ...
    def init_weights(self, pretrained=None):
        super(HorNet, self).init_weights(pretrained)
            ...
            if self.init_cfg is None:
                for m in self.modules():
                    if isinstance(m, (nn.Linear)):
                        ...
                        nn.LayerNorm, nn.BatchNorm2d, HorNetLayerNorm)):

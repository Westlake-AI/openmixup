...
class Meta3D(BaseModule):
    ...
    def __init__(self,
        ...
        if use_layer_scale:
            self.ls1 = LayerScale(dim, data_format='channels_last')
            self.ls2 = LayerScale(dim, data_format='channels_last')
        else:
...
class EfficientFormer(BaseBackbone):
    ...
    A PyTorch implementation of EfficientFormer introduced by: `EfficientFormer:
    ...
    def init_weights(self, pretrained=None):
        super(EfficientFormer, self).init_weights(pretrained)

...
# modified from mmclassification twins.py
import math
import torch
...
class PCPVT(BaseBackbone):
    """The backbone of Twins-PCPVT.

    This backbone is the implementation of `Twins: Revisiting the Design of
    Spatial Attention in Vision Transformers
    <https://proceedings.neurips.cc/paper/2021/hash/4e0928de075538c593fbdabb0c5ef2c3-Abstract.html>`_.
    ...
    def init_weights(self, pretrained=None):
        if self.init_cfg is not None:
            super(PCPVT, self).init_weights(pretrained)
        else:

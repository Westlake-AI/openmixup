...
from .resnet_mmcls import ResLayer, ResNetV1d
...
class ResNeSt(ResNetV1d):
    ...
    A PyTorch implementation of : `ResNeSt: Split-Attention Networks
    <https://arxiv.org/abs/2004.08955>`_

    Modified from the `official repo
    <https://github.com/zhanghang1989/ResNeSt/tree/master/resnest>`_

...
model = dict(
    ...
    mix_block = dict(  # V2, update v08.24
        ...
        lam_mul=True, lam_residual=True, lam_mul_k=0.5,  # V2 lam: mult + k=0.25
    ...
    head_mix_k=dict(  # mixblock
        ...
        two_hot=False, two_hot_mode='none', two_hot_thr=1, two_hot_idx=1, neg_weight=0.01,  # try small neg
        in_channels=512, num_classes=200),

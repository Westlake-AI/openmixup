_base_ = [
    '../../../_base_/datasets/flowers102/sz224_bs16.py',
...
model = dict(
    ...
    mask_adjust=0,
    lam_margin=0.0,  # degenerate to mixup when lam or 1-lam <= 0.08
    ...
    head_one=dict(
        ...
        with_avg_pool=True, multi_label=False, in_channels=512, num_classes=102),
...
custom_hooks = [
    dict(type='SAVEHook',
         iter_per_epoch=350,
         save_interval=350*10,  # plot every 500 x 10 ep
    ),

...
def main():
    ...
    # For example: generate the optimal config for Mixup on ImageNet as
    #   |-- configs/classification/imagenet/mixup/baseline/r18/mix_modemixup/
    #   |   |--> r18_mixups_CE_none_alpha0_2_ep100.py

    ## default CE
    base_path = "configs/classification/imagenet/mixup/baseline/r18_mixups_CE_none.py"
    # base_path = "configs/classification/imagenet/mixup/baseline/r34_mixups_CE_none.py"
    # base_path = "configs/classification/imagenet/mixup/baseline/r50_mixups_CE_none.py"
    # base_path = "configs/classification/imagenet/mixup/baseline/r101_mixups_CE_none.py"
    # base_path = "configs/classification/imagenet/mixup/baseline/rx101_mixups_CE_none.py"
    ## soft CE
    # base_path = "configs/classification/imagenet/mixup/baseline/r50_mixups_CE_soft.py"
    ## BCE (sigmoid)
    # base_path = "configs/classification/imagenet/mixup/baseline/r50_mixups_CE_sigm.py"
    ## multi-mode mixup (using various mixup policies)
    # base_path = "configs/classification/imagenet/mixup/baseline/r50_mixups_CE_soft_multi_mode.py"
    # base_path = "configs/classification/imagenet/mixup/rbs_a3/r50_rsb_a3_CE_sigm_multi_mode_sz160_bs2048.py"
    ## decouple mixup
    # base_path = "configs/classification/imagenet/mixup/decouple/r50_mixups_CE_soft_decouple.py"
    ## rbs a3
    # base_path = "configs/classification/imagenet/mixup/rbs_a3/r50_rsb_a3_CE_sigm_sz160_bs2048.py"

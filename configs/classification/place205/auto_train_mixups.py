...
def main():
    ...
    Usage:
        Generating various mixup methods' configs by executing
            `python configs/classification/place205/auto_train_mixups.py`
    """

    # *** mixups ***
    base_path = "configs/classification/place205/mixups/r18_mixups_CE_none_4xb64.py"
    # base_path = "configs/classification/place205/mixups/r50_mixups_CE_none_4xb64.py"

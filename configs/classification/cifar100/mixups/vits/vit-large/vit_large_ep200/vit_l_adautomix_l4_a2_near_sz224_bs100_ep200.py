_base_ = [
    '../../../../../_base_/datasets/cifar100/sz224_randaug_4xbs25.py',
...
model = dict(
    ...
    backbone=dict(
        ...
        drop_path_rate=0.1,
        out_indices=(11, 23),  # ViT-S: 8 layers, use 4-layer for MixBlock
    ),
    mix_block=dict(
        type='AdaptiveMask',
        in_channel=1024,
...
update_interval = 2  # total: 8 x bs128 x 1 accumulates = bs1024

custom_hooks = [
    dict(type='SAVEHook',
        save_interval=500 * 20 * update_interval,  # 20 ep
        iter_per_epoch=500,
    ),
...
addtional_scheduler = dict(
    policy='CosineAnnealing',
    by_epoch=False, min_lr=0.,  # 0.1 x lr

...
# Aircrafts
data_train_labeled_list = 'data/meta/Aircrafts/image_list/train_30.txt'  # download from Self-Tuning
data_train_unlabeled_list = 'data/meta/Aircrafts/image_list/unlabeled_30.txt'

...
# CUB200
data_train_labeled_list = 'data/meta/CUB200/image_list/train_15.txt'  # download from Self-Tuning
data_train_unlabeled_list = 'data/meta/CUB200/image_list/unlabeled_15.txt'

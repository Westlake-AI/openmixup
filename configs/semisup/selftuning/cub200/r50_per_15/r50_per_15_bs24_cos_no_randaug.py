...
model = dict(
    ...
    head_cls=dict(
        ...
        with_avg_pool=True, in_channels=2048, num_classes=200)
)
# dataset settings
data_source_cfg = dict(type='ImageNet')
# CUB200
cub_base = "data/CUB200/"
data_train_labeled_list = cub_base + 'image_list/train_15.txt'  # download from Self-Tuning
data_train_unlabeled_list = cub_base + 'image_list/unlabeled_15.txt'

...
model = dict(
    ...
    head_cls=dict(
        ...
        with_avg_pool=True, in_channels=2048, num_classes=196)
)
# dataset settings
data_source_cfg = dict(type='ImageNet')
# StanfordCars
data_base = "data/StanfordCars/"
data_train_labeled_list = data_base + 'image_list/train_50.txt'  # download from Self-Tuning
data_train_unlabeled_list = data_base + 'image_list/unlabeled_50.txt'
